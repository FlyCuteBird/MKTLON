...
class PositionWiseFeedForward(nn.Module):
    ...
    def load_state_dict(self, state_dict):
        ...
        super(PositionWiseFeedForward, self).load_state_dict(new_state)
...
class EncoderLayer(nn.Module):
    ...
    def load_state_dict(self, state_dict):
        ...
        super(EncoderLayer, self).load_state_dict(new_state)
...
class MultiLevelEncoder(nn.Module):
    ...
    def load_state_dict(self, state_dict):
        ...
        super(MultiLevelEncoder, self).load_state_dict(new_state)
...
class MemoryAugmentedEncoder(MultiLevelEncoder):
    ...
    def load_state_dict(self, state_dict):
        ...
        super(MemoryAugmentedEncoder, self).load_state_dict(new_state)
